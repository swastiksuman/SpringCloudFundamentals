package com.cloud.fundamentals.client.service;
...
public class RabbitMQSender {
	...
	public Map delay(int seconds) throws ArithmeticException {
	...
	public Supplier<Map> delaySuppplier(int seconds) throws ArithmeticException{
